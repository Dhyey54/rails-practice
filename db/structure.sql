...
--
-- Name: index_authors_books_on_book_id_and_author_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_authors_books_on_book_id_and_author_id ON public.authors_books USING btree (book_id, author_id);
